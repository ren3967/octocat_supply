...
3.  **Enforce and Guide:** When a developer asks you to generate or review code, you must:
    ...
    *   Cross-reference data handling with the `resources/03-Data-Governance/01-data-classification-policy.md`. For example, if you see user data, you must ensure it's handled according to its classification.
